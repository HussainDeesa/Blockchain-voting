...
contract Election {
    ...
    function getElectionDetails() public view returns(string, string,address) {
        return (election_name,election_description,election_authority);    
    }
}
...
//         // companyEmail[email].deployedAddress = 0x3D04F08f33314524Fd315c829d90b6799Bd3a6E3;
//         companyEmail[email].deployedAddress = newElection;
//         companyEmail[email].el_n = election_name;
//         companyEmail[email].el_d = election_description;
//     }
...
//         election_authority = authority;
//         // election_authority = 0x3D04F08f33314524Fd315c829d90b6799Bd3a6E3;
//         election_name = name;
//         election_description = description;
//         status = true;
//     }
...
//     mapping (uint8=>VoterHash) voterhashes;
...
//     // function to add voterhash

//     function addVoterHash(string memory hash) public owner {
...
//         }
//         bytes memory s = new bytes(i); // i is the actual length of the string
//         for (uint j = 0; j < i; j++) {
//             s[j] = reversed[i - j - 1]; // reverse the string
//         }
//         return string(s);
//     }
//       function findVoterHash(string memory hash) public view returns (string memory) {
//         for (uint8 i = 0; i < voterCount; i++) {
//             // string memory voterID = uintToString(i);
//             if (keccak256(bytes(voterhashes[i].hash)) == keccak256(bytes(hash))) {
//                 return "found";
//             }
//         }
//         return "Not found";
